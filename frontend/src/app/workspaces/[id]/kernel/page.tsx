        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
            <header className="h-20 border-b border-white/5 flex items-center px-8 justify-between backdrop-blur-md sticky top-0 z-10 bg-[#0a0a0b]/50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-lg font-black tracking-tight uppercase">System Kernel</h2>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
                            <span className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Architect Configuration • {currentWorkspace?.name || workspaceId}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/5 border border-white/5">
                        ...
                        <span className="text-[10px] font-black text-gray-600 uppercase">Core Lockdown Active</span>
                    </div>
                </div>
            </header>
                ...
                <div className="max-w-5xl mx-auto space-y-10">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        {[
                            ...
                            >
                                ...
                                <div className="text-[9px] font-black text-gray-600 uppercase tracking-widest leading-none">{stat.label}</div>
                                <div className={cn("text-xl font-black tracking-tighter leading-none", stat.color)}>{stat.value}</div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <div className="bg-[#121214] border border-white/10 rounded-[3rem] shadow-2xl overflow-hidden h-[800px] flex flex-col">
                        <div className="p-10 border-b border-white/5 bg-gradient-to-r from-white/[0.01] to-transparent">
                            <h3 className="text-3xl font-black uppercase tracking-tighter mb-2">Core Parameters</h3>
                    ...
                    <div className="p-8 rounded-[2rem] bg-indigo-500/5 border border-indigo-500/10 flex items-center justify-between pb-20">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-black uppercase tracking-tight text-white">Global Manifest Controls</h4>
                                <p className="text-xs text-indigo-400/60 font-medium">Access system-wide account and subscription nodes.</p>
                            </div>
                        </div>
                        <button
                            className="px-6 py-3 rounded-xl bg-[#0a0a0b] border border-indigo-500/20 text-indigo-400 font-black uppercase text-[10px] tracking-widest hover:bg-indigo-500 hover:text-white transition-all active:scale-95 shadow-lg shadow-indigo-500/5"
                        >
                            Open Master Kernel
                        </button>
                    </div>
