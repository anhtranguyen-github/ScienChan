    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 lg:p-8">
            ...
            <motion.div
                ...
                className="relative bg-[#121214] border border-white/10 w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
            >
                {/* Header */}
                ...
                <div className="px-10 py-8 flex items-center justify-between border-b border-white/5 bg-white/[0.01]">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-white tracking-tight uppercase">Capability Forge</h2>
                            <div className="flex items-center gap-2 mt-1">
                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em]">Tool Integration Layer</span>
                                <span className="w-1 h-1 rounded-full bg-orange-500/50 animate-pulse" />
                                <span className="text-[10px] text-amber-400 font-mono uppercase">{tools.length} Active Modules</span>
                            </div>
                        </div>
                    </div>
                    <button
                        ...
                        {isAdding ? (
                            ...
                            >
                                <div className="space-y-6">
                                    <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.25em] border-b border-white/5 pb-2">Manifest New Module</h3>

                                    <div className="grid gap-6">
                                        <div className="space-y-3">
                                            <label className="text-[10px] font-black text-gray-600 uppercase tracking-widest ml-1">Internal Reference ID</label>
                                            <div className="relative group">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-[#0a0a0b] border border-white/10 rounded-2xl pl-14 pr-6 py-5 text-sm text-white outline-none focus:ring-2 ring-amber-500/20 focus:border-amber-500/50 transition-all font-medium"
                                                    value={newTool.id || ''}
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[#0a0a0b] border border-white/10 rounded-2xl px-6 py-5 text-sm text-white outline-none focus:ring-2 ring-amber-500/20 focus:border-amber-500/50 transition-all font-medium"
                                                value={newTool.name || ''}
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-[10px] font-black text-gray-600 uppercase tracking-widest ml-1">Functional Description</label>
                                            <textarea
                                                placeholder="Briefly explain what this module performs..."
                                                className="w-full bg-[#0a0a0b] border border-white/10 rounded-2xl px-6 py-5 text-sm text-white outline-none focus:ring-2 ring-amber-500/20 focus:border-amber-500/50 transition-all font-medium h-32 resize-none"
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-[10px] font-black text-gray-600 uppercase tracking-widest ml-1">Module Protocol</label>
                                            <div className="grid grid-cols-2 gap-4">
                                                {[
                                                    ...
                                                    >
                                                        <div className="text-[10px] font-black uppercase tracking-tighter mb-1">{type.label}</div>
                                                        <div className={cn("text-[9px] font-bold", newTool.type === type.id ? "text-amber-100/50" : "text-gray-700")}>{type.sub}</div>
                                                    </button>
                                                ))}
                                            </div>
                                        </div>
                                ...
                                <div className="flex justify-end gap-4 pt-4">
                                    ...
                                    <button
                                        onClick={handleAdd}
                                        className="px-10 py-4 bg-white text-black text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl hover:scale-105 active:scale-95 transition-all"
                                    >
                                        Seal Integration
                                    </button>
                                </div>
                            ...
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.25em] border-b border-white/5 pb-2">Integrated Modules</h3>
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3">
                                                        <h4 className={cn("text-sm font-black uppercase tracking-tight", tool.enabled ? "text-black" : "text-gray-500")}>{tool.name}</h4>
                                                        <span className={cn(
                                                    ...
                                                    <p className={cn("text-[10px] font-medium mt-1 max-w-[300px] line-clamp-1", tool.enabled ? "text-gray-600" : "text-gray-700")}>{tool.description}</p>
                                                </div>
                                            </div>
                ...
                {!isAdding && (
                    <div className="px-10 py-8 border-t border-white/5 bg-white/[0.01]">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.25em]">Forge New Capability Hook</span>
                        </button>
                    </div>
                )}
            </motion.div>
